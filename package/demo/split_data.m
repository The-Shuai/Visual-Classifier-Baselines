...
% tr_idx: the label of labeled trainging data 训练集有标签数据的标号
% tr_fea: labeled training data 训练集有标签的数据
% idx_unlabelled: the label of unlabeled trainging data 训练集无标签数据的标号
% tr_fea_unlabelled: unlabeled training data 训练集无标签的数据
% val_idx: the label of validation data 验证集标号
% val_fea: validation data 验证集数据
% ts_idx: the label of testinging data 测试集标号
% ts_fea: testinging data 测试集数据
