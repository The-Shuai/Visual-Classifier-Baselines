function [accuracy,acc_map] = KNRC_ADMM_classifier(tr_max_fea,tr_label,ts_max_fea,ts_label,par)
...
% Codes = lasso_admm_kernel4NRC(kernel_tstr', kernel_train,  trace(kernel_test), maxiter);
Codes = NNLS(ts_max_fea, tr_max_fea, maxiter);
